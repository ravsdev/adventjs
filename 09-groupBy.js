...
Por suerte a Mark Zucktheelf 🧝 se le ha ocurrido crear una función que permita agrupar un array, que puede ser de valores u objetos,
...
export default function groupBy(collection, it) {
  ...
  collection.forEach(el=>{
    let result=resolveIt(el,it);
    
    if(groupResult.hasOwnProperty(result)){
      groupResult[result].push(el)
    }else{
      groupResult[result]=[el]
    }
  })
